...
__Vectors       DCD     __initial_sp  ; Top of Stack
                ...
                ; External Interrupts
                DCD     Reserved_16_IRQHandler  ; Reserved interrupt 
                DCD     Reserved_17_IRQHandler  ; Reserved interrupt 
                DCD     Reserved_18_IRQHandler  ; Reserved interrupt 
                DCD     Reserved_19_IRQHandler  ; Reserved interrupt 
                DCD     Reserved_20_IRQHandler  ; Reserved interrupt 20
                DCD     FTFA_IRQHandler  ; FTFA command complete/read collision interrupt
                DCD     LVD_LVW_IRQHandler  ; Low Voltage Detect, Low Voltage Warning
                DCD     Reserved_23_IRQHandler  ; Reserved interrupt 
                ...
                DCD     Reserved_36_IRQHandler  ; Reserved interrupt 
                DCD     Reserved_37_IRQHandler  ; Reserved interrupt 
                DCD     Reserved_38_IRQHandler  ; Reserved interrupt 
                DCD     Reserved_39_IRQHandler  ; Reserved interrupt 39
                DCD     Reserved_40_IRQHandler  ; Reserved interrupt 40
                DCD     Reserved_41_IRQHandler  ; Reserved interrupt 41
                DCD     Reserved_42_IRQHandler  ; Reserved interrupt 42
...
Default_Handler PROC
                EXPORT  Reserved_16_IRQHandler     [WEAK]
                EXPORT  Reserved_17_IRQHandler     [WEAK]
                EXPORT  Reserved_18_IRQHandler     [WEAK]
                EXPORT  Reserved_19_IRQHandler     [WEAK]
                EXPORT  Reserved_20_IRQHandler     [WEAK]
                EXPORT  FTFA_IRQHandler     [WEAK]
                EXPORT  LVD_LVW_IRQHandler     [WEAK]
                EXPORT  Reserved_23_IRQHandler     [WEAK]
                ...
                EXPORT  Reserved_36_IRQHandler     [WEAK]
                EXPORT  Reserved_37_IRQHandler     [WEAK]
                EXPORT  Reserved_38_IRQHandler     [WEAK]
                EXPORT  Reserved_39_IRQHandler     [WEAK]
                EXPORT  Reserved_40_IRQHandler     [WEAK]
                EXPORT  Reserved_41_IRQHandler     [WEAK]
                EXPORT  Reserved_42_IRQHandler     [WEAK]
...
Reserved_16_IRQHandler
Reserved_17_IRQHandler
Reserved_18_IRQHandler
Reserved_19_IRQHandler
Reserved_20_IRQHandler
FTFA_IRQHandler
LVD_LVW_IRQHandler
Reserved_23_IRQHandler
I2C0_IRQHandler
I2C1_IRQHandler
SPI0_IRQHandler
...
Reserved_36_IRQHandler
Reserved_37_IRQHandler
Reserved_38_IRQHandler
Reserved_39_IRQHandler
Reserved_40_IRQHandler
Reserved_41_IRQHandler
Reserved_42_IRQHandler
MCG_IRQHandler
LPTimer_IRQHandler
